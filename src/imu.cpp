...
void Imu::doCalculations() {
  ...
  float lastFrequency = 1000000 / _lastInterval;
  _sample->axesGyro.roll = _sample->axesGyro.roll + (_sample->coordGyro.x / lastFrequency);
  _sample->axesGyro.pitch = _sample->axesGyro.pitch + (_sample->coordGyro.y / lastFrequency);
  _sample->axesGyro.yaw = _sample->axesGyro.yaw + (_sample->coordGyro.z / lastFrequency);

  _sample->axesGyroCalibrated.roll = _sample->axesGyroCalibrated.roll + ((_sample->coordGyro.x - _sample->coordGyroDrift.x) / lastFrequency);
  _sample->axesGyroCalibrated.pitch = _sample->axesGyroCalibrated.pitch + ((_sample->coordGyro.y - _sample->coordGyroDrift.y) / lastFrequency);
  _sample->axesGyroCalibrated.yaw = _sample->axesGyroCalibrated.yaw + ((_sample->coordGyro.z - _sample->coordGyroDrift.z) / lastFrequency);

  _sample->axes.roll = _sample->axes.roll + ((_sample->coordGyro.x - _sample->coordGyroDrift.x) / lastFrequency);
  _sample->axes.pitch = _sample->axes.pitch + ((_sample->coordGyro.y - _sample->coordGyroDrift.y) / lastFrequency);
  _sample->axes.yaw = _sample->axes.yaw + ((_sample->coordGyro.z - _sample->coordGyroDrift.z) / lastFrequency);
